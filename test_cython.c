...
static PyObject *__pyx_pf_11test_cython_test(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_x) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_11test_cython_test(__pyx_v_x, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
 ...
 * cpdef int test(int x):
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_Cython, 0, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Cython, __pyx_t_1) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
